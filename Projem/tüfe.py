...
st.markdown(f"<h4 style='font-size:20px;'>TÜFE Enflasyonu ({secim})</h4>",unsafe_allow_html=True)
...
fig.update_layout(title={"text":f"Tüketici Enflasyonu 2003=100 (%) ({secim})","x":0.5,"xanchor":"center"},
...
fig2.update_layout(title={"text":f"TÜFE 2003=100 (%) ({secim})","x": 0.5,"xanchor":"center"},
